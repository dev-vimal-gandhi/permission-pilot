...
import com.servalabs.perms.common.upgrade.core.MyPermSku
import com.servalabs.perms.common.upgrade.core.UpgradeRepoGplay
import com.servalabs.perms.common.upgrade.core.data.SkuDetails
...
class UpgradeViewModel @Inject constructor(
    ...
    val state: StateFlow<Pricing?> = flow {
        ...
        val iapDetails = skuDetails?.firstOrNull { it.sku.type == com.servalabs.perms.common.upgrade.core.data.Sku.Type.IAP }
        val subDetails = skuDetails?.firstOrNull { it.sku.type == com.servalabs.perms.common.upgrade.core.data.Sku.Type.SUBSCRIPTION }
