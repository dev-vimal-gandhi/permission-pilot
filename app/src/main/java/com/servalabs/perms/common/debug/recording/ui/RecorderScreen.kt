package com.servalabs.perms.common.debug.recording.ui
...
private fun RecorderScreenPreview() = PreviewWrapper {
    RecorderScreen(
        state = RecorderActivityVM.State(
            logDir = File("/storage/emulated/0/Android/data/com.servalabs.perms/files/debug/logs/myperm_1.0_123_abc12345"),
            logEntries = listOf(
